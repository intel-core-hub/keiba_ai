"""Wrapper delegating AutonomousResearcher to research.autonomous_researcher.

This keeps backwards compatibility with imports from `core` while the
implementation has been moved to `research`. The real class is loaded
on first instantiation to avoid import-time circular dependencies.
"""

def _load_impl():
    from research.autonomous_researcher import AutonomousResearcher as _Impl
    return _Impl
